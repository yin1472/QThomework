...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        actionactAbout = new QAction(QWMainWind);
        actionactAbout->setObjectName("actionactAbout");
        ...
        menu_4->addAction(actionactAbout);
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actionactAbout->setText(QCoreApplication::translate("QWMainWind", "actAbout", nullptr));
